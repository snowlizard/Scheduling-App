...
How to run
After program load enter your users credentials. Upon successful login you'll be redirected to the home menu. This menu provides easy navigation to the Appointments, Customers, and Reports menus. Click on any button to be redirect to their respective page.
